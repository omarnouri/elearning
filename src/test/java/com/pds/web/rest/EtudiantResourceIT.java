...
class EtudiantResourceIT {
    ...
    public static Etudiant createEntity(EntityManager em) {
        Etudiant etudiant = new Etudiant().nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM);
        return etudiant;
    }
    ...
    public static Etudiant createUpdatedEntity(EntityManager em) {
        Etudiant etudiant = new Etudiant().nom(UPDATED_NOM).prenom(UPDATED_PRENOM);
        return etudiant;
    }
    ...
    void putNewEtudiant() throws Exception {
        ...
        updatedEtudiant.nom(UPDATED_NOM).prenom(UPDATED_PRENOM);
