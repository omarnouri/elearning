package com.pds.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.pds.IntegrationTest;
import com.pds.repository.timezone.DateTimeWrapper;
import com.pds.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ee_date_time_wrapper where id=%d", fieldName, id);
    }
