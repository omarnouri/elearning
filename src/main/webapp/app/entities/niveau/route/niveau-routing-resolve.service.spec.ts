...
describe('Service Tests', () => {
  describe('Niveau routing resolve service', () => {
    ...
    let routingResolveService: NiveauRoutingResolveService;
    let service: NiveauService;
    let resultNiveau: INiveau | undefined;
    ...
    beforeEach(() => {
      ...
      routingResolveService = TestBed.inject(NiveauRoutingResolveService);
    ...
    describe('resolve', () => {
      ...
      it('should return new INiveau if id is not provided', () => {
        // GIVEN
        ...
        expect(resultNiveau).toEqual(new Niveau());
      });

      it('should route to 404 page if data not found in server', () => {
        // GIVEN
        jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Niveau })));
        mockActivatedRouteSnapshot.params = { id: 123 };
